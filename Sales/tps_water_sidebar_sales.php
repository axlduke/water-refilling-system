<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <hr class="sidebar-divider">
			<div class="sidebar-heading">
                <font color="yellow"><img src='../img/report_sales.png' width='35px' height='35px' style="border-radius: 50%"> SALES</font>
            </div>
			 ...
			 <li class="nav-item active">
                ...
                <div id="collapseDaily" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="sales_list.php">View</a>
			 ...
			 <li class="nav-item">
                ...
                <div id="collapseMonthly" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="sales_list_monthly.php">View</a>
			 ...
			 <li class="nav-item">
                ...
                <div id="collapseYearly" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="sales_list_yearly.php">View</a>
                        <a class="collapse-item" href="cards.html">Print</a>
                    </div>
                </div>
            </li>
			<!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="Sales_graph.php">
