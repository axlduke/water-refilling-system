<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
           ...
           <!-- Divider -->
			...
			<div class="sidebar-heading">
                <font color="yellow">
				<img src='../img/maintenance_logo.png' width='35px' height='35px' style="border-radius: 50%"> MAINTENANCE</font>
            </div>
			...
			<li class="nav-item">
                <a class="nav-link" href="" data-toggle="modal" data-target="#addMonitorModal">
                     <i class="fas fa-fw"></i><i class="fas fa-fw fa-table"></i>
                    <span>Monitoring now!</span></a>
            </li><!-- Divider -->
