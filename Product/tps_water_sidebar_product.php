<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
           ...
           <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
			...
			<img src='../img/productbw.png' width='40px' height='40px' style="border-radius: 50%">
			 ...
			 <li class="nav-item active">
                ...
                <div id="collapseProd" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="" data-toggle="modal" data-target="#addProductModal">Add</a>
                        <a class="collapse-item" href="product_list_update.php?update=1">update</a>
						 <a class="collapse-item" href="product_list.php?update=0">view</a>
                    </div>
                </div>
