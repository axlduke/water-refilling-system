...
<body id="page-top">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                        ...
                        <div class="input-group">
							...
							<h1 class="h3 mb-2 text-gray-800">Manage Owner Password  <img src='../img/password_protect.png' width='40px' height='40px' style="border-radius: 50%"></h1>
                        </div>
    ...
    <div class="card card-register mx-auto mt-6">
      ...
      <div class="card-body">
        <form action="updatePasswordOwner.php" method="POST">
          ...
          <div class="form-group">
            <div class="form-label-group">
			  ...
			  <input type="checkbox" class="custom-control-input" id="showhide">
				<label for="showhide" onclick="myFunction()">
					<img src="../img/view_eye.png" width='20px' alt="view" class="img-fluid"> click to show/ hide password
				</label>
		  ...
		  <br/>
          <input type="submit" class="btn btn-primary btn-block" value="Change Password now!" name="changePass" id="btnPass">
          <a class="btn btn-danger btn-block" href="../product/product_list.php">Cancel</a>
        </form>
