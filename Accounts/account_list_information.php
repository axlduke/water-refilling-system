...
<head>
    ...
    <title>TPS New Account Info</title>
...
<body id="page-top">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form
                        ...
                        <div class="input-group">
							...
							<h1 class="h3 mb-2 text-gray-800">New Account Information  <img src='product.png' width='40px' height='40px' style="border-radius: 50%"></h1>
                        </div>
                    </form>
    ...
    <div class="card card-register mx-auto mt-6">
      <div class="card-header">New Added Account Information</div>
      <div class="card-body">
        <form action="product_infoEdit.php" method="POST">
            ...
            <div class="form-row">
              <div class="col-md-3">
                <div class="form-label-group">
				  <label for="pid1">Username: </label><br/>
				 <label><b style='color:blue'> <?php echo $_SESSION['username'];?></b>
                </div>
              </div>
          ...
          <div class="form-group">
            <div class="form-label-group">
			 ...
			 <label><b style='color:blue'> <?php echo $_SESSION['password'];?></b>
              
            </div>
          </div>
		  <div class="form-group">
            <div class="form-label-group">
              <label for="pname">Access Level: </label><br/>
			 <label><b style='color:blue'> <?php echo $_SESSION['ac_level'];?></b>
